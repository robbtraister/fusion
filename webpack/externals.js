...
module.exports = {
  ...
  '@robbtraister/fusion-components': getExternal(
    '../src/fusion/components',
    'FusionComponents'
  ),
  '@robbtraister/fusion-components/app': getExternal(
    '../src/fusion/components/app',
    ['FusionComponents', 'App']
  ),
  '@robbtraister/fusion-components/tree': getExternal(
    '../src/fusion/components/tree',
    ['FusionComponents', 'Tree']
  ),

  // should only be used on the server
  'react-dom/server': getExternal('react-dom/server'),
  '@robbtraister/fusion-components/utils': getExternal(
    '../src/fusion/components/utils'
  )
}
